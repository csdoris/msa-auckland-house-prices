# Analysis of Auckland House Prices

### Datasets
[House price dataset](https://github.com/csdoris/msa-auckland-house-prices/blob/master/Properties.csv "House price dataset")
[Final dataset with 2018 Census Population and the Deprivation index](https://github.com/csdoris/msa-auckland-house-prices/blob/master/add-deprivation.csv "Final dataset with 2018 Census Population and the Deprivation index")
### Notebook files
